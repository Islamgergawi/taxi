...
package com.ondemandbay.taxianytime.gcmlib;
...
public final class GCMRegistrar {
    ...
    /**
     * {@link com.google.android.gcm.GCMBroadcastReceiver} instance used to handle the retry intent.
     *
     * <p>
    ...
    public static void checkManifest(Context context) {
        ...
        for (ActivityInfo receiver : receivers) {
            if (com.google.android.gcm.GCMConstants.PERMISSION_GCM_INTENTS.equals(
                    receiver.permission)) {
     ...
     * {@link com.google.android.gcm.GCMConstants#INTENT_FROM_GCM_REGISTRATION_CALLBACK} intent with
     * either a {@link com.google.android.gcm.GCMConstants#EXTRA_REGISTRATION_ID} or
     * {@link com.google.android.gcm.GCMConstants#EXTRA_ERROR}.
     *
     * @param context application context.
    ...
    static void internalRegister(Context context, String... senderIds) {
        ...
        Intent intent = new Intent(com.google.android.gcm.GCMConstants.INTENT_TO_GCM_REGISTRATION);
        intent.setPackage(GSF_PACKAGE);
        setPackageNameExtra(context, intent);
        intent.putExtra(com.google.android.gcm.GCMConstants.EXTRA_SENDER, flatSenderIds);
     ...
     * <p>
     * The result will be returned as an
     * {@link com.google.android.gcm.GCMConstants#INTENT_FROM_GCM_REGISTRATION_CALLBACK} intent with an
     * {@link com.google.android.gcm.GCMConstants#EXTRA_UNREGISTERED} extra.
     */
    ...
    static void internalUnregister(Context context) {
        ...
        Intent intent = new Intent(com.google.android.gcm.GCMConstants.INTENT_TO_GCM_UNREGISTRATION);
        intent.setPackage(GSF_PACKAGE);
        setPackageNameExtra(context, intent);
        context.startService(intent);
    }
    ...
    private synchronized static void setPackageNameExtra(Context context,
        ...
        intent.putExtra(com.google.android.gcm.GCMConstants.EXTRA_APPLICATION_PENDING_INTENT,
                sAppPendingIntent);
    }

    /**
     * Lazy initializes the {@link com.google.android.gcm.GCMBroadcastReceiver} instance.
     */
    static synchronized void setRetryBroadcastReceiver(Context context) {
        if (sRetryReceiver == null) {
            if (sRetryReceiverClassName == null) {
                ...
                sRetryReceiver = new com.google.android.gcm.GCMBroadcastReceiver();
            } else {
                Class<?> clazz;
                try {
                    clazz = Class.forName(sRetryReceiverClassName);
                    sRetryReceiver = (com.google.android.gcm.GCMBroadcastReceiver) clazz.newInstance();
                } catch (Exception e) {
                    Log.e(TAG, "Could not create instance of " +
                            sRetryReceiverClassName + ". Using " +
                            com.google.android.gcm.GCMBroadcastReceiver.class.getName() +
                            " directly.");
                    sRetryReceiver = new com.google.android.gcm.GCMBroadcastReceiver();
                }
            }
